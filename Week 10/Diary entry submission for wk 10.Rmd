...
Upon scrolling data.gov, I was interested in finding out more about resale flat prices, particularly since I am graduating soon and will be looking for one. My final topic is **Resale flat prices based on registration date from Jan-2017 onwards**. In question 2 I will describe why I chose this data set.
